...
///   Solend reserve `BgxfHJ…`. Authorized by the operator during the
///   May 2026 demo window; not previously pinned in-repo because the
///   gateway decodes it dynamically from the live reserve account
